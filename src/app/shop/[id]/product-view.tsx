...
import { QuantitySelector } from "@/components/QuantitySelector"; // adjust import path
  ...
  return (
    <section className="product-detail-container flex flex-col md:flex-row gap-8 ">
      ...
      <div className="product-images flex flex-col gap-4">
        ...
        {/* 🔹 Inside Favorite with Main product image */}
        <div className="main-image relative">

          {/* 🔹 Top-right favorite toggle overlay */}
          <span
            role="button"
            onClick={toggleFavorite}
            aria-pressed={isFavorited ? "true" : "false"}
            aria-label={isFavorited ? "Remove from favorites" : "Add to favorites"}
            className="absolute bottom-2 right-2 z-10 p-1 rounded-full bg-white/90 hover:bg-white shadow-sm 
            border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-300"
      ...
      <div className="product_info flex-1 space-y-4">
        ...
        {sizes.length > 0 && (
          <div className="product-option mb-4 ">
            <label className="product-option-label block font-medium mb-1 text-gray-800">Size:</label>
              ...
              {sizes
                ...
                .map((s) => (
                  <span
                    ...
                    aria-pressed={selectedSize === s ? "true" : "false"}
                    //  + gap prevents items from collapsing; add padding and rounded for tap targets
                    style ={{ padding: "2px 4px", borderRadius: "1px", cursor: "pointer" }}
                    className={`items-center gap-2 px-3 py-1 rounded cursor-pointer-${selectedSize === s ? "active" : "inactive"} ${
                      selectedSize === s
        ...
        {/* ✅ Quantity Selector */}
        <QuantitySelector qty={qty} setQty={setQty} min={1} max={10} />
        ...
        {/* Add to Cart */}
          <button
            ...
            className="add-to-cart-btn btn btn-primary px-4 py-2 rounded bg-blue-600 
        ...
        <div  className="mt-6 border-t pt-6" style={{marginTop: "20px"}}>
          <p className="mb-4 font-medium text-gray-700">Share this product with your friends:</p>
