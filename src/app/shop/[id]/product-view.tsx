      ...
      <div className="product_info flex-1 space-y-4">
              ...
              {sizes
                ...
                .map((s) => (
                  <span
                    ...
                    // inline-flex + gap prevents items from collapsing; add padding and rounded for tap targets
                    className={`items-center gap-2 px-3 py-1 rounded cursor-pointer ${
                      selectedSize === s
        ...
        {/* Add to Cart */}
          <button
            ...
            className="add-to-cart-btn btn btn-primary px-4 py-2 rounded bg-blue-600 text-white flex items-center gap-2 mb-2"
        ...
        <div className="mt-6 border-t pt-6">
          ...
          <div className="inline-flex flex-row items-center gap-4 p-3 bg-gray-50 rounded-lg overflow-x-auto">
            {/* Facebook */}
            <a
              ...
              className="inline-flex items-center justify-center min-w-[32px] w-8 h-8 hover:opacity-70 hover:scale-110 transition-all duration-150 ease-in-out shrink-0"
            >
