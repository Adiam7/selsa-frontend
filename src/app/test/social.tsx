...
<div className="mt-6 border-t pt-6">
  ...
  <div className="flex flex-row items-center gap-2 p-3 bg-gray-50 rounded-lg">
    ...
    <a
      ...
      className=" items-center justify-center w-8 h-8 hover:opacity-70 hover:scale-110 transition-all duration-150 ease-in-out shrink-0"
    >
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className=" items-center justify-center w-8 h-8 hover:opacity-80 transition-opacity"
    >
