    ...
    if (g) {
        let p = {
            ...
            t = new function() {
                ...
                return a(!1), r(!1), s((() => {
                    ...
                    !function() {
                        ...
                        if (m.navigator.sendBeacon) {
                            ...
                            null != (t = null == t || null != t.group && null != t.name ? t : null) && (20 < t.group.length || 50 < t.name.length) && (t = null),
                            e.storefrontAbTest = t,
                            (e => (e = e.substring(0, e.length - 6), 31536e6 < Date.now() - e))(n.visitorId) && d(),
                            e.visitorId = n.visitorId,
                            m.navigator.sendBeacon(g + "/register", JSON.stringify(e)),
                            f("send", e)
                        }
                ...
                function s(e) {
                    f("updateVisitorId", e),
                    null == e ? d() : n.visitorId = t(p.visitorId, e),
                    m.analytics_visitorId = n.visitorId
                }
                function i(e) {
                    f("updatePlatformId", e),
                    null == e ? (f("resetPlatformId"), n.platformId = v()) : n.platformId = t(p.platformId, e)
                }
                function l(e) {
                    f("updateSessionId", e),
                    null == e ? u() : n.sessionId = t(p.sessionId, e),
                    n.sessionId && !c(n.sessionId) || u()
                }
                function a(e) {
                    n.verbose = e
                }
                ...
                function u() {
                    f("resetSession"),
                    n.sessionId = t(p.sessionId, y())
                }
                function d() {
                    f("resetVisitorId"),
                    n.visitorId = t(p.visitorId, y())
                }
                function t(e, t) {
                    if (t = t || y(), n.allowCookies)
                        try {
                            f("localStorage.setItem", e + "=" + t),
        ...
        function y() {
            ...
            for (e = e.substring(0, 6); e.length < 6;)
                e = "0" + e;
            return +new Date + "" + e
        }
    } else
